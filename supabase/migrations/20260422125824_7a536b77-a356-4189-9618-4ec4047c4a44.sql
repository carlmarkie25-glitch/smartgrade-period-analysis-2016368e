CREATE OR REPLACE FUNCTION public.get_student_period_ranks_for_class(
  p_student_id uuid,
  p_class_id uuid,
  p_periods period_type[]
)
RETURNS TABLE(period period_type, class_rank integer, total_students integer, is_incomplete boolean, total_score numeric)
LANGUAGE sql
STABLE
SECURITY DEFINER
